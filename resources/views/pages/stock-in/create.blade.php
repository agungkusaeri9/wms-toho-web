...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-4">Create Stock In</h4>
                    <form action="{{ route('stock-ins.store') }}" method="post">
                        ...
                        <div class='form-group mb-3'>
                            <label for='product_part_number' class='mb-2'>Part No.</label>
                            <input type='text' name='product_part_number' id='product_part_number'
                                class='form-control @error('product_part_number') is-invalid @enderror'
                                value='{{ old('product_part_number') }}' readonly>
                        </div>
                        <div class='form-group mb-3'>
                        ...
                        <div class="form-group">
                            <button class="btn btn-primary float-right">Create Stock In</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        $('#product_id').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#product_part_number').val(data.part_number.name);
                },
                error: function(err) {
                    console.log(err);
                }
