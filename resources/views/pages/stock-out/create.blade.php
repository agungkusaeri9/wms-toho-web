                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="javascript:void(0)" id="product-form">
                                ...
                                <div class='form-group mb-3'>
                                    <label for='product_unit' class='mb-2'>Product Unit</label>
...
@push('scripts')
    ...
    <script>
        ...
        function updateTable() {
            ...
            let products = JSON.parse(localStorage.getItem('products-out')) || [];
        ...
        $('.btnAdd').on('click', function() {
            ...
            localStorage.setItem('products-out', JSON.stringify(products));
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.status) {
                                ...
                                localStorage.removeItem('products-out');
                                setTimeout(function() {
                                    let back = '{{ route('stock-outs.index') }}';
